...
test('脚本节点卡片显示保存和提取失败原因并可按步骤重试', () => {
  ...
  assert.match(scriptActionsSource, /function successScriptStatus\(episodeId, step, message, scriptContent = ''\)/)
  ...
  assert.match(scriptActionsSource, /resultNodeId: firstExtractResultNodeId\(drama\.value, step\)/)
  ...
  assert.match(scriptActionsSource, /successScriptStatus\(episodeId, 'extract_chars', '角色提取完成', scriptContent\)/)
  assert.match(scriptActionsSource, /successScriptStatus\(episodeId, 'extract_scenes', '场景提取完成', episodeScriptContent\(drama\.value, episodeId\)\)/)
  assert.match(scriptActionsSource, /successScriptStatus\(episodeId, 'extract_props', '道具提取完成', episodeScriptContent\(drama\.value, episodeId\)\)/)
  assert.match(scriptActionsSource, /successScriptStatus\(episodeId, 'extract_all', '一键提取完成', content\)/)
