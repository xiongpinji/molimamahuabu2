...
test('model capabilities estimate resolution-tier and per-request video cost', () => {
  ...
  assert.equal(estimateCanvasCredits(tieredCatalog, 'video', 'tiered-video', 1, 8, '480P'), 48)
  assert.equal(estimateCanvasCredits(tieredCatalog, 'video', 'tiered-video', 1, 8, '720p'), 96)
  assert.equal(estimateCanvasCredits(tieredCatalog, 'video', 'tiered-video', 1, 12, '720p'), null)
