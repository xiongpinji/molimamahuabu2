...
<style scoped>
.account-badge { position: fixed; z-index: 3000; top: 12px; right: 18px; bottom: auto; display: flex; align-items: center; gap: 12px; max-width: calc(100vw - 36px); padding: 6px 10px; border: 1px solid rgba(255,255,255,.1); border-radius: 12px; color: #fff; background: rgba(27, 27, 30, .92); box-shadow: 0 10px 30px rgba(0,0,0,.24); backdrop-filter: blur(12px); }
.account-badge--canvas { right: 230px; }
...
@media (max-width: 860px) {
  .account-badge { top: 68px; left: 10px; right: 10px; overflow-x: auto; }
  .account-badge--canvas { right: 10px; }
}
</style>
