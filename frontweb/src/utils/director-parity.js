...
export const DIRECTOR_SCENE_TEMPLATES = [
  { name: '空白场景', people: 0, props: [] },
  { name: '单人口播', people: 1, props: [], camera: '正面中景' },
  { name: '产品讲解', people: 1, props: ['方桌', '图片板'], camera: '正面中景' },
  { name: '展板讲解', people: 1, props: ['图片板'], camera: '正面全景' },
  { name: '双人对话', people: 2, props: [], camera: '正面中景' },
  { name: '访谈节目', people: 2, props: ['椅子', '椅子', '方桌'], camera: '正面中景' },
  { name: '街头采访', people: 2, props: ['路灯'], camera: '侧面近景' },
  { name: '圆桌讨论', people: 4, props: ['圆桌', '椅子', '椅子', '椅子', '椅子'], camera: '俯拍全景' },
  { name: '课堂教学', people: 6, props: ['图片板', '方桌'], camera: '正面全景' },
  { name: '舞台演讲', people: 1, props: ['图片板'], camera: '低角度仰拍' },
  { name: '新闻发布会', people: 3, props: ['方桌', '图片板'], camera: '正面全景' },
  { name: '咖啡厅会面', people: 2, props: ['圆桌', '椅子', '椅子'], camera: '侧面近景' },
  { name: '公园小憩', people: 2, props: ['长椅', '小树', '灌木'], camera: '正面全景' },
  { name: '街头同行', people: 2, props: ['路灯'], camera: '侧面跟拍' },
  { name: '街头道别', people: 2, props: ['路灯'], camera: '正面中景' },
  { name: '车内对话', people: 2, props: ['轿车'], camera: '过肩镜头' },
  { name: '追逐戏', people: 3, props: [], camera: '远景跟踪' },
  { name: '对峙打斗', people: 2, props: [], camera: '低角度广角' },
  { name: '舞蹈表演', people: 5, props: [], camera: '正面全景' },
  { name: '庆祝时刻', people: 6, props: [], camera: '45° 俯拍' },
]

export const DIRECTOR_SPEED_PRESETS = [
  { name: '无', rate: 1, easing: 'linear' },
  { name: '自定义', rate: 1, easing: 'custom' },
  { name: '蒙太奇', rate: 1.5, easing: 'ease-in-out' },
  { name: '英雄时刻', rate: 0.5, easing: 'ease-out' },
  { name: '子弹时间', rate: 0.25, easing: 'ease-in-out' },
  { name: '跳接', rate: 2, easing: 'step' },
  { name: '闪进', rate: 1.5, easing: 'ease-in' },
  { name: '闪出', rate: 1.5, easing: 'ease-out' },
]

export const DIRECTOR_POSE_MIRROR_SECTIONS = [
  { label: '手臂', left: 'leftShoulder', right: 'rightShoulder' },
  { label: '前臂', left: 'leftElbow', right: 'rightElbow' },
  { label: '手腕', left: 'leftWrist', right: 'rightWrist' },
  { label: '腿部', left: 'leftHip', right: 'rightHip' },
  { label: '小腿', left: 'leftKnee', right: 'rightKnee' },
  { label: '脚踝', left: 'leftAnkle', right: 'rightAnkle' },
]
...
const CROWD_ROLE_KINDS = ['male', 'female', 'child', 'broad', 'slim']
