...
export const DIRECTOR_POSE_MIRROR_SECTIONS = [
  { label: '臂', left: 'leftShoulder', right: 'rightShoulder' },
  { label: '肘', left: 'leftElbow', right: 'rightElbow' },
  { label: '腕', left: 'leftWrist', right: 'rightWrist' },
  { label: '腿', left: 'leftHip', right: 'rightHip' },
  { label: '膝', left: 'leftKnee', right: 'rightKnee' },
  { label: '踝', left: 'leftAnkle', right: 'rightAnkle' },
]
