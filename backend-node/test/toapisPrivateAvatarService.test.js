...
test('ToAPIs 虚拟人像客户端使用官方建组、建素材和查询路径', async () => {
  ...
  assert.deepEqual(calls.map((item) => [item.init.method, item.url]), [
    ['POST', 'https://toapis.com/v1/videos/doubao-seedance-2-0/private-avatar/groups'],
    ['POST', 'https://toapis.com/v1/videos/doubao-seedance-2-0/private-avatar/assets'],
    ['GET', 'https://toapis.com/v1/videos/doubao-seedance-2-0/private-avatar/assets/pa_asset1'],
  ]);
